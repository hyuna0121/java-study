...
//	일하는 중입니다.
	...
	public static void main(String[] args) {
		SchoolMember[] array = new SchoolMember[3];
		array[0] = new Student();
		array[1] = new Teacher();
		array[2] = new Staff();
		
		// 모든 구성원 소개
		for (SchoolMember obj : array) {
			obj.introduce();
			if (obj instanceof Student student) student.study();
			else if (obj instanceof Teacher teacher) teacher.teach();
			else if (obj instanceof Staff staff) staff.work();
		}
	}
}
