...
public class CalendarExample {
	public static void main(String[] args) {
		...
		if (today.isBefore(targetDate)) System.out.println("오늘은 크리스마스 전입니다.");
		else if (today.isAfter(targetDate)) System.out.println("오늘은 크리스마스 이후입니다.");
		else System.out.println("오늘은 크리스마스입니다!");
		
		// 시간 비교
		LocalDateTime todayTime = LocalDateTime.now();
		LocalDateTime deadline = LocalDateTime.of(2025, 8, 4, 18, 0); // 2025년 8월 4일 오후 6시
		
		if (todayTime.isBefore(deadline)) System.out.println("마감 시간 전입니다. 작업을 계속하세요.");
		else if (todayTime.isAfter(deadline)) System.out.println("마감 시간이 지났습니다. 제출을 마감합니다.");
		else System.out.println("지금이 마감 시간입니다.");
		...
		System.out.println("전체 일 수 차이 : " + daysBetween + "일");
	}
}
